    ...
    EIP712 
{
    ...
    /// @dev Represents the explicit trust boundary. The engine only accepts commands from this specific controller.
    ...
    /// @dev Anti-griefing measure to completely eliminate unbounded loops during signature validation.
    ...
    function executeProposal(
        ...
        if (_signatures.length != threshold * 65) revert LAWPMultiSigController_InvalidSignatureLength();
        ...
        // Bounded loop: Only checks exactly the `threshold` number of signatures.
